...
// NewEventStoreRepositoryWithTx creates an EventStoreRepository with a specific transaction
func NewEventStoreRepositoryWithTx(tx *gorm.DB) *EventStoreRepository {
	return &EventStoreRepository{db: tx}
}
